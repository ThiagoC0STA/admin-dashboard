...
import { FaLinkedin, FaGithubSquare, FaInstagram, FaGrinWink } from "react-icons/fa";
...
export const socialMedias = [
  {
    media: 'LinkedIn',
    name: 'linkedin' ,
    icon: <FaLinkedin className="text-7xl text-[#0a66c2]"/>,
    links: 'https://www.linkedin.com/in/thiago-rodrigues-da-costa-525242210/'
  },
  {
    media: 'Github',
    name: 'github',
    icon: <FaGithubSquare className="text-7xl "/>,
    links: 'https://github.com/ThiagoC0STA'
  },
  {
    media: 'Instagram',
    name: 'instagram',
    icon: <FaInstagram id="insta-gradient" className="text-white rounded-lg"/>,
    links: 'https://instagram.com/rodc_dev'
  },
  {
    media: 'Email',
    name: 'email',
    icon: <SiGmail className="text-7xl p-2 text-[#cc1e1a]"/>,
    links: 'https://is.gd/rodcdev'
  },
]
